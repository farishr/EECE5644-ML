...
directory = r'D:\NEU Notes\EECE5644 - Intro to ML\Python\HW2\Datasets\sentance_class\SentenceCorpus\labeled_articles'
...
csv_file_name = 'word_mapping.csv'
...
with open(csv_file_name, 'w', newline='') as csv_file:
    ...
    # Write key-value pairs as rows in the CSV file
